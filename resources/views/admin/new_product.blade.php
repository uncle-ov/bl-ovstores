    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-lg-9 order-md-last">
                <div class="row">
                    <form action="{{ URL('/admin/products/new') }}" class="billing-form" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="short_description" class="form-control" placeholder="Product short description" required>{{ old('short_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="long_description" class="form-control" placeholder="Product long description" required>{{ old('long_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="category" value="{{ old('category') }}" id="" class="form-control" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="manufacturer" value="{{ old('manufacturer') }}" id="" class="form-control" required>
                                        @foreach($manufacturers as $item)
                                        <option value="{{ $item->id }}" {{ $item->id == old('manufacturer') ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
